...
#################################################################
#CPU Utilizadarr
PromedioCPU=$( mpstat | grep all | awk '{print $3'})
...
PDiscoUtulizado=$(df | grep /dev/root | awk '{print $3'})
DiscoTamano=$(df | grep /dev/root | awk '{print $2'})
...
###################################################################
#Comando para correr cada 3 min el script
#watch -n 180 ./ScriptSISOPER
